...
const listAiGenerated: IconVariants = {
  Stroke: [
    [
      'path',
      {
  ...
  Contrast: [
    [
      'path',
      {
        d: 'M18 13C18.6375 14.6165 19.3391 15.345 21 16C19.3391 16.655 18.6375 17.3835 18 19C17.3625 17.3835 16.6609 16.655 15 16C16.6609 15.345 17.3625 14.6165 18 13Z',
        fill: 'currentColor',
        opacity: 0.28,
        key: 'c0',
      },
  ...
  'Duo Stroke': [
    ['path', { d: 'M4 12H13.5M4 18H10M4 6H20', stroke: 'currentColor', opacity: 0.28, key: 'd0' }],
    [
      'path',
      {
...
export const ListAiGenerated = createIcon('list-ai-generated', listAiGenerated);
export default ListAiGenerated;
