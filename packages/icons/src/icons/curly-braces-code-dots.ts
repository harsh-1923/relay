...
const curlyBracesCodeDots: IconVariants = {
  Stroke: [
    [
      'path',
      {
  ...
  'Duo Stroke': [
    ...
    ['path', { d: 'M12.001 12H12M15.001 12H15M9.001 12H9', stroke: 'currentColor', key: 'd1' }],
  ],
  'Duo Solid': [
    [
      'path',
...
export const CurlyBracesCodeDots = createIcon('curly-braces-code-dots', curlyBracesCodeDots);
export default CurlyBracesCodeDots;
