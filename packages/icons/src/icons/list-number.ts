...
const listNumber: IconVariants = {
  ...
  'Duo Stroke': [
    ['path', { d: 'M21 6H11M21 12H11M21 18H11', stroke: 'currentColor', opacity: 0.28, key: 'd0' }],
    [
      'path',
      {
...
export const ListNumber = createIcon('list-number', listNumber);
