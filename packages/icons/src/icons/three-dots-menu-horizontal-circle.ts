...
const threeDotsMenuHorizontalCircle: IconVariants = {
  Stroke: [
    [
      'path',
      {
  ...
  'Duo Stroke': [
    ...
    ['path', { d: 'M8 12H8.01M12 12H12.01M16 12H16.01', stroke: 'currentColor', key: 'd1' }],
  ],
  'Duo Solid': [
    [
      'path',
...
export const ThreeDotsMenuHorizontalCircle = createIcon(
  'three-dots-menu-horizontal-circle',
  threeDotsMenuHorizontalCircle,
);
export default ThreeDotsMenuHorizontalCircle;
