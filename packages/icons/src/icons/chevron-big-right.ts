...
const chevronBigRight: IconVariants = {
  ...
  Contrast: [
    [
      'path',
      {
        d: 'M14.8172 12.5101C13.1364 14.5771 11.1808 16.423 9 18C9.33276 14.0069 9.33276 9.99308 9 6C11.1808 7.57701 13.1364 9.42294 14.8172 11.4899C15.0609 11.7897 15.0609 12.2103 14.8172 12.5101Z',
        fill: 'currentColor',
        opacity: 0.28,
        key: 'c0',
      },
...
export const ChevronBigRight = createIcon('chevron-big-right', chevronBigRight);
