...
const micOn: IconVariants = {
  ...
  Contrast: [
    ...
    [
      'path',
      {
        d: 'M12 20C7.58172 20 4 16.4183 4 12M12 20C16.4183 20 20 16.4183 20 12M12 20V22M16 7V12C16 14.2091 14.2091 16 12 16C9.79086 16 8 14.2091 8 12V7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z',
        stroke: 'currentColor',
        key: 'c1',
      },
    ],
...
export const MicOn = createIcon('mic-on', micOn);
