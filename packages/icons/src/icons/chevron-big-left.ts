...
const chevronBigLeft: IconVariants = {
  Stroke: [
    [
      'path',
      {
  ...
  Contrast: [
    [
      'path',
      {
        d: 'M9.18284 12.5101C10.8636 14.5771 12.8192 16.423 15 18C14.6672 14.0069 14.6672 9.99308 15 6C12.8192 7.57701 10.8636 9.42294 9.18284 11.4899C8.93905 11.7897 8.93905 12.2103 9.18284 12.5101Z',
        fill: 'currentColor',
        opacity: 0.28,
        key: 'c0',
      },
...
export const ChevronBigLeft = createIcon('chevron-big-left', chevronBigLeft);
