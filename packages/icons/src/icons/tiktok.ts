...
const tiktok: IconVariants = {
  ...
  'Duo Stroke': [
    [
      'path',
      {
        d: 'M13.9889 2V17.5556C13.9889 20.0102 11.999 22 9.54442 22C7.08982 22 5.09998 20.0102 5.09998 17.5556C5.09998 15.101 7.08982 13.1111 9.54442 13.1111',
        stroke: 'currentColor',
        opacity: 0.28,
        key: 'd0',
      },
    ...
    [
      'path',
      {
        d: 'M13.9889 2L14.8386 3.91194C15.6955 5.83992 17.4633 7.2087 19.5444 7.55556',
        stroke: 'currentColor',
        key: 'd1',
      },
    ],
...
export const Tiktok = createIcon('tiktok', tiktok);
