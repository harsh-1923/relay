...
const chevronBigDown: IconVariants = {
  ...
  Contrast: [
    [
      'path',
      {
        d: 'M11.4899 14.8172C9.42293 13.1364 7.57701 11.1808 6 9C9.99308 9.33276 14.0069 9.33276 18 9C16.423 11.1808 14.5771 13.1364 12.5101 14.8172C12.2103 15.0609 11.7897 15.0609 11.4899 14.8172Z',
        fill: 'currentColor',
        opacity: 0.28,
        key: 'c0',
      },
...
export const ChevronBigDown = createIcon('chevron-big-down', chevronBigDown);
