...
const searchBigZoomOut: IconVariants = {
  ...
  Contrast: [
    ...
    [
      'path',
      {
        d: 'M17.5104 17.5104C19.0486 15.9722 20 13.8472 20 11.5C20 6.80558 16.1944 3 11.5 3C6.80558 3 3 6.80558 3 11.5C3 16.1944 6.80558 20 11.5 20C13.8472 20 15.9722 19.0486 17.5104 17.5104ZM17.5104 17.5104L21 21M8.5 11.5H14.5',
        stroke: 'currentColor',
        key: 'c1',
      },
    ],
...
export const SearchBigZoomOut = createIcon('search-big-zoom-out', searchBigZoomOut);
