...
const alarmRemove: IconVariants = {
  Stroke: [
    [
      'path',
      {
  ...
  'Duo Stroke': [
    ...
    ['path', { d: 'M5 3L2 6M19 3L22 6M9 13H15', stroke: 'currentColor', key: 'd1' }],
  ],
  'Duo Solid': [
    [
      'path',
...
export const AlarmRemove = createIcon('alarm-remove', alarmRemove);
