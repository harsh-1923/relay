...
const downloadBarDown: IconVariants = {
  Stroke: [
    [
      'path',
      {
  ...
  'Duo Stroke': [
    ['path', { d: 'M19 20H5', stroke: 'currentColor', opacity: 0.28, key: 'd0' }],
    [
      'path',
      {
...
export const DownloadBarDown = createIcon('download-bar-down', downloadBarDown);
export default DownloadBarDown;
