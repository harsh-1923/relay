...
const searchDefaultZoomIn: IconVariants = {
  Stroke: [
    [
      'path',
      {
  ...
  'Duo Stroke': [
    ...
    ['path', { d: 'M10 13V10M10 10V7M10 10H7M10 10H13', stroke: 'currentColor', key: 'd1' }],
  ],
  'Duo Solid': [
    [
      'path',
...
export const SearchDefaultZoomIn = createIcon('search-default-zoom-in', searchDefaultZoomIn);
export default SearchDefaultZoomIn;
