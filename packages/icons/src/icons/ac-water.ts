...
const acWater: IconVariants = {
  ...
  Contrast: [
    ...
    [
      'path',
      {
        d: 'M19.7999 19.2C19.7999 20.7464 18.5463 22 17 22C15.4536 22 14.2 20.7464 14.2 19.2C14.2 17.6536 16.3 15 17 15C17.7 15 19.7999 17.6536 19.7999 19.2Z',
        fill: 'currentColor',
        opacity: 0.28,
        key: 'c1',
      },
...
export const AcWater = createIcon('ac-water', acWater);
