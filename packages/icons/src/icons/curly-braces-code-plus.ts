...
const curlyBracesCodePlus: IconVariants = {
  Stroke: [
    [
      'path',
      {
  ...
  'Duo Stroke': [
    ...
    ['path', { d: 'M12 15V12M12 12V9M12 12L9 12M12 12L15 12', stroke: 'currentColor', key: 'd1' }],
  ],
  'Duo Solid': [
    [
      'path',
...
export const CurlyBracesCodePlus = createIcon('curly-braces-code-plus', curlyBracesCodePlus);
export default CurlyBracesCodePlus;
