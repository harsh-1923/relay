...
const productHunt: IconVariants = {
  Stroke: [
    [
      'path',
      {
        d: 'M10 13.625V8H12.8125C14.3658 8 15.625 9.2592 15.625 10.8125C15.625 12.3658 14.3658 13.625 12.8125 13.625H10ZM10 13.625V17M12 21.1501C6.94657 21.1501 2.84998 17.0535 2.84998 12.0001C2.84998 6.94669 6.94657 2.8501 12 2.8501C17.0534 2.8501 21.15 6.94669 21.15 12.0001C21.15 17.0535 17.0534 21.1501 12 21.1501Z',
        stroke: 'currentColor',
        key: 's0',
      },
    ],
  ...
  Contrast: [
    [
      'path',
      {
        d: 'M2.84998 12.0001C2.84998 17.0535 6.94657 21.1501 12 21.1501C17.0534 21.1501 21.15 17.0535 21.15 12.0001C21.15 6.94669 17.0534 2.8501 12 2.8501C6.94657 2.8501 2.84998 6.94669 2.84998 12.0001Z',
        fill: 'currentColor',
        opacity: 0.28,
        key: 'c0',
      },
...
export const ProductHunt = createIcon('product-hunt', productHunt);
