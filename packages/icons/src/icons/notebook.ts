...
const notebook: IconVariants = {
  Stroke: [
    [
      'path',
      {
        d: 'M12 5.06642V21.5M12 21.5C9.06309 20.165 5.19684 19.1964 2 20.5664V5.06641C4.99481 3.35509 8.9751 3.96646 12 5.06642C15.0249 3.96646 19.0052 3.3551 22 5.06642V20.5664C18.8032 19.1964 14.9369 20.165 12 21.5Z',
        stroke: 'currentColor',
        key: 's0',
      },
    ],
  ...
  Contrast: [
    ...
    [
      'path',
      {
        d: 'M12 21.5V5.06642M12 5.06642C8.9751 3.96646 4.99481 3.35509 2 5.06641V20.5664C5.19684 19.1964 9.06309 20.165 12 21.5C14.9369 20.165 18.8032 19.1964 22 20.5664V5.06642C19.0052 3.3551 15.0249 3.96646 12 5.06642Z',
        stroke: 'currentColor',
        key: 'c1',
      },
    ],
  ...
  'Duo Stroke': [
    ['path', { d: 'M12 21.5V5.06641', stroke: 'currentColor', opacity: 0.28, key: 'd0' }],
    [
      'path',
      {
        d: 'M2 20.5664V5.06641C4.99481 3.35509 8.9751 3.96646 12 5.06642C15.0249 3.96646 19.0052 3.3551 22 5.06642V20.5664C18.8032 19.1964 14.9369 20.165 12 21.5C9.06309 20.165 5.19684 19.1964 2 20.5664Z',
  ...
  'Duo Solid': [
    ...
    ['path', { d: 'M12 21.5039V5', stroke: 'currentColor', key: 'd1' }],
  ],
};

export const Notebook = createIcon('notebook', notebook);
