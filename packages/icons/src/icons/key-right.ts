...
const keyRight: IconVariants = {
  ...
  'Duo Stroke': [
    [
      'path',
      { d: 'M18 12H22V15M18 12H10M18 12V14', stroke: 'currentColor', opacity: 0.28, key: 'd0' },
    ],
    [
      'path',
      {
  ...
  'Duo Solid': [
    ...
    [
      'path',
      {
        d: 'M6 7C8.76142 7 11 9.23858 11 12C11 14.7614 8.76142 17 6 17C3.23858 17 1 14.7614 1 12C1 9.23858 3.23858 7 6 7Z',
        fill: 'currentColor',
        key: 'd1',
      },
    ],
...
export const KeyRight = createIcon('key-right', keyRight);
