...
const arrowLeft: IconVariants = {
  ...
  Contrast: [
    [
      'path',
      {
        d: 'M4.20952 12.5943C5.83783 14.6272 7.727 16.4444 9.8304 18L9.53 12L9.8304 6C7.727 7.55556 5.83783 9.37278 4.20952 11.4057C4.06984 11.5801 4 11.79 4 12C4 12.21 4.06984 12.4199 4.20952 12.5943Z',
        fill: 'currentColor',
        opacity: 0.28,
        key: 'c0',
      },
    ...
    [
      'path',
      {
        d: 'M9.53 12L9.8304 18C7.727 16.4444 5.83783 14.6272 4.20952 12.5943C4.06984 12.4199 4 12.21 4 12C4 11.79 4.06984 11.5801 4.20952 11.4057C5.83783 9.37278 7.727 7.55556 9.8304 6L9.53 12ZM9.53 12L20 12',
        stroke: 'currentColor',
        key: 'c1',
      },
    ],
  ...
  'Duo Solid': [
    ...
    [
      'path',
      {
        d: 'M3 12C3 11.5675 3.1443 11.136 3.42903 10.7805C5.11149 8.68001 7.0632 6.80273 9.23579 5.19599C9.53936 4.97149 9.94349 4.9371 10.2806 5.10709C10.6178 5.27707 10.8304 5.62244 10.8304 6.00001L10.8304 18C10.8304 18.3776 10.6177 18.7229 10.2806 18.8929C9.94349 19.0629 9.53936 19.0285 9.23579 18.804C7.06319 17.1973 5.11149 15.32 3.42903 13.2195C3.1443 12.864 3 12.4325 3 12Z',
        fill: 'currentColor',
        key: 'd1',
      },
    ],
