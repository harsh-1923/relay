...
const divideCircle: IconVariants = {
  Stroke: [
    [
      'path',
      {
  ...
  'Duo Stroke': [
    ...
    ['path', { d: 'M8 12H16M12 8H12.001M12 16H12.001', stroke: 'currentColor', key: 'd1' }],
  ],
  'Duo Solid': [
    [
      'path',
...
export const DivideCircle = createIcon('divide-circle', divideCircle);
